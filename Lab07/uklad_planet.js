...
function startGL()
{
  ...
  `;
    ...
    for(let elevation=-90; elevation< 90; elevation+= stepElevation) //slonce
    {
        for(let angle = 0; angle < 360; angle+= stepAngle)
        {
...
function handlekeydown(e)
{
    ...
    if(event.keyCode===37) // <-  oróbt kamery w lewo
    {
        angleY=angleY-Step*1;
    }
    if(event.keyCode===39) // -> oróbt kamery w prawo
    {
        angleY=angleY+Step*1;
    }
